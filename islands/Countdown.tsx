...
export default function Countdown(props: { target: string }) {
    ...
    // Set up an interval to update the `now` date every second with the
    // current date as long the component is mounted.
    useEffect(() => {
    ...
    // Otherwise, we format the remaining time using `Intl.RelativeTimeFormat`
    // and render it.
